 ...
 *
 * Instantiate the directive at the top of your file (outside your class definition), or you
 * could make it a class property.
 *
 ...
 * @param {function} callback - An event callback function.
 */
